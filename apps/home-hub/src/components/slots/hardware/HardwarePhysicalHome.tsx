// src/components/slots/hardware/HardwarePhysicalHome.tsx
'use client';
import React from 'react';
import { House, Thermometer, Wind, Lock, LockKeyOpen, Sun } from '@phosphor-icons/react';
import { PhysicalHomeProps } from '../types';
import styles from './HardwarePhysicalHome.module.css';

export function HardwarePhysicalHome({
  telemetry,
  doorLocked,
  onToggleDoorLock,
  ambianceScene,
    ...
    <div className={styles.card}>
      ...
      <div className={styles.tilesGrid}>
        ...
        <div className={styles.tile}>
          <div className={styles.tileTop}>
            ...
            {doorLocked ? (
              ...
              <LockKeyOpen size={14} weight="bold" color="#f58e2a" aria-hidden="true" />
            )}
          </div>
          <span
        ...
        >
          <div className={styles.tileTop}>
            <span>Ambiance</span>
            <Sun size={14} weight="fill" color="#f58e2a" aria-hidden="true" />
          </div>
