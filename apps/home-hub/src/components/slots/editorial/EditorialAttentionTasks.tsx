// src/components/slots/editorial/EditorialAttentionTasks.tsx
'use client';
import React from 'react';
import { Bell } from '@phosphor-icons/react';
import { AttentionTasksProps } from '../types';
import styles from './EditorialAttentionTasks.module.css';

export function EditorialAttentionTasks({
  title,
  pendingCountTag,
  tasks,
  onToggleTask,
