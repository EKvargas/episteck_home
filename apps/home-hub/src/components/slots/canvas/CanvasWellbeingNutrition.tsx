// src/components/slots/canvas/CanvasWellbeingNutrition.tsx
'use client';
import React from 'react';
import { Heartbeat, Stethoscope } from '@phosphor-icons/react';
import { WellbeingNutritionProps } from '../types';
import styles from './CanvasWellbeingNutrition.module.css';

export function CanvasWellbeingNutrition({
  personContext,
  title,
  subtitle,
  targetTag,
          ...
          <div className={styles.gaugeContainer}>
            <div className={styles.svgWrapper}>
              <svg className={styles.gaugeSvg} viewBox="0 0 100 100">
                <defs>
                  <linearGradient id="canvasGaugeGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#2e66f6" />
                ...
                <circle
                  ...
                  strokeLinecap="round"
                  fill="transparent"
                  style={{ filter: 'drop-shadow(0 2px 8px rgba(46, 102, 246, 0.4))' }}
                />
              </svg>
          ...
          <div className={styles.macrosCol}>
            ...
            <div className={styles.macroItem}>
              <div className={styles.macroHeader}>
                ...
                <span className={styles.macroRemaining} style={{ color: '#0bb579' }}>
        ...
        <div className={styles.anaCareArea}>
          ...
          <div className={styles.anaVitalsGrid}>
            ...
            <div className={styles.anaVitalCard}>
              ...
              <span className={styles.anaVitalSub} style={{ color: '#2e66f6' }}>
