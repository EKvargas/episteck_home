// src/components/slots/canvas/CanvasPhysicalHome.tsx
'use client';
import React from 'react';
import { House, Thermometer, Wind, Lock, LockKeyOpen, Sun } from '@phosphor-icons/react';
import { PhysicalHomeProps } from '../types';
import styles from './CanvasPhysicalHome.module.css';

export function CanvasPhysicalHome({
  telemetry,
  doorLocked,
  onToggleDoorLock,
  ambianceScene,
      ...
      <div className={styles.tilesGrid}>
        ...
        <div className={styles.tile}>
          <div className={styles.tileTop}>
            ...
            {doorLocked ? (
              <Lock size={14} weight="bold" color="#059669" aria-hidden="true" />
            ) : (
              <LockKeyOpen size={14} weight="bold" color="#ff5c38" aria-hidden="true" />
            )}
          </div>
          <span
        ...
        >
          <div className={styles.tileTop}>
            <span>Ambiance</span>
            <Sun size={14} weight="fill" color="#f59e0b" aria-hidden="true" />
          </div>
