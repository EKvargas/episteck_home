// src/components/slots/warm/WarmPhysicalHome.tsx
'use client';
import React from 'react';
import { House, Thermometer, Wind, Lock, LockKeyOpen, Sun } from '@phosphor-icons/react';
import { PhysicalHomeProps } from '../types';
import styles from './WarmPhysicalHome.module.css';

export function WarmPhysicalHome({
  telemetry,
  doorLocked,
  onToggleDoorLock,
  ambianceScene,
      ...
      <div className={styles.tilesGrid}>
        ...
        <div className={styles.tile}>
          <div className={styles.tileTop}>
            ...
            {doorLocked ? (
              <Lock size={14} weight="bold" color="#3c7849" aria-hidden="true" />
            ) : (
              <LockKeyOpen size={14} weight="bold" color="#c4643c" aria-hidden="true" />
            )}
          </div>
          <span
        ...
        >
          <div className={styles.tileTop}>
            <span>Ambiance</span>
            <Sun size={14} weight="fill" color="#c4643c" aria-hidden="true" />
          </div>
