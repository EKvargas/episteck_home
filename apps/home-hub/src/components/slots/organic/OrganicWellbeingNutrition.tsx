// src/components/slots/organic/OrganicWellbeingNutrition.tsx
'use client';
import React from 'react';
import { Heartbeat, Stethoscope } from '@phosphor-icons/react';
import { WellbeingNutritionProps } from '../types';
import styles from './OrganicWellbeingNutrition.module.css';

export function OrganicWellbeingNutrition({
  personContext,
  title,
  subtitle,
  targetTag,
            ...
            <div className={styles.svgWrapper}>
              <svg className={styles.gaugeSvg} viewBox="0 0 100 100">
                ...
                <circle
                  ...
                  strokeLinecap="round"
                  fill="transparent"
                  style={{ filter: 'drop-shadow(0 2px 6px rgba(73, 113, 76, 0.3))' }}
                />
              </svg>
          ...
          <div className={styles.macrosCol}>
            ...
            <div className={styles.macroItem}>
              <div className={styles.macroHeader}>
                ...
                <span className={styles.macroRemaining} style={{ color: '#8f77a5' }}>
        ...
        <div className={styles.anaCareArea}>
          ...
          <div className={styles.anaVitalsGrid}>
            ...
            <div className={styles.anaVitalCard}>
              ...
              <span className={styles.anaVitalSub} style={{ color: '#8f77a5' }}>
