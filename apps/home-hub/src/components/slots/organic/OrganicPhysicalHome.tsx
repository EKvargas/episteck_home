// src/components/slots/organic/OrganicPhysicalHome.tsx
'use client';
import React from 'react';
import { House, Thermometer, Wind, Lock, LockKeyOpen, Sun } from '@phosphor-icons/react';
import { PhysicalHomeProps } from '../types';
import styles from './OrganicPhysicalHome.module.css';

export function OrganicPhysicalHome({
  telemetry,
  doorLocked,
  onToggleDoorLock,
  ambianceScene,
      ...
      <div className={styles.tilesGrid}>
        ...
        <div className={styles.tile}>
          <div className={styles.tileTop}>
            ...
            {doorLocked ? (
              <Lock size={14} weight="bold" color="#2c5330" aria-hidden="true" />
            ) : (
              <LockKeyOpen size={14} weight="bold" color="#d97742" aria-hidden="true" />
            )}
          </div>
          <span
        ...
        >
          <div className={styles.tileTop}>
            <span>Ambiance</span>
            <Sun size={14} weight="fill" color="#d97742" aria-hidden="true" />
          </div>
